...
{/* Filters */}
<div className="d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center gap-2 mb-2">
  ...
  <div className="d-flex flex-column flex-sm-row gap-2 flex-grow-1 flex-md-grow-0">
    ...
    <div className="dropdown flex-grow-1">
      <button 
        className="btn  text-black border bg-white p-1 dropdown-toggle w-100" 
        type="button" 
        data-bs-toggle="dropdown" 
        aria-expanded="false"
      >
        ...
        <table className="table table-bordered text-center align-middle product-table mb-0">
          <thead className="table-light text-white">
            <tr>
              ...
              <th className="px-3">Amount Due</th>
            ...
            {currentRows.map((invoice, idx) => (
              <tr key={idx}>
                ...
                <td className="d-flex justify-content-center gap-1">
                  <button
                    className="btn outline-info btn-sm border text-info boder "
