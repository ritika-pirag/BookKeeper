            ...
            {products.map((prod, idx) => (
              <tr key={idx}>
                ...
                <td className="d-flex justify-content-center gap-1">
                  <button
                    className="btn outline-info btn-sm py-1 px-1 text-info border "
                    data-bs-toggle="modal"
                  ...
                  <button
                                                className="btn outline-primary  btn-sm text-warning py-1 px-1 border "
                  ...
                  <button
       className="btn outline-primary btn-sm text-danger py-2 px-1 border "
                    data-bs-toggle="modal"
