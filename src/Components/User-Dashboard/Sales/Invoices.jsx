...
// import "./Invoice.css";
import logo from '../../../assets/newlogozirakbookk.png'
...
const Invoices = () => {
  ...
  const confirmDelete = () => {
   ...
   const PaymentStatusWithQr = ({ status }) => (
    <div className="d-flex align-items-center gap-3">
      ...
      {status === "Paid" && (
        <div 
          className="qr-payment-status" 
          onClick={() => handleShowQr(selectedInvoice)}
          style={{ cursor: 'pointer' }}
        >
          <QRCodeSVG 
            value={`INVOICE:${selectedInvoice?.invoiceNo}`} 
            size={60}
            level="H"
            includeMargin={true}
            fgColor="#000000"
  ...
  return (
    <div className="container-fluid bg-light py-4 px-4 product-header">
      {/* Header */}
            ...
            <div className="row mb-4">
              ...
              <div className="col-md-6">
                ...
                <p className="mb-1">Phone: +1 987 471 6589</p>
                 ...
                 {/* Updated Payment Status section */}
                  <div className="d-flex justify-content-between mb-4">
                    <PaymentStatusWithQr status={selectedInvoice.status} />
                    <div>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content border-0" style={{ borderRadius: 16 }}>
            <div className="modal-body text-center py-4">
              ...
              {/* QR Code Payment Status Modal */}
      {showQrModal && selectedInvoice?.status === "Paid" && (
        <div className="qr-payment-modal-overlay">
          <div className="qr-payment-modal-content">
            <div className="qr-payment-modal-header">
              <h5>Payment Status</h5>
              <button className="qr-payment-modal-close" onClick={closeQrModal}>
                <FaTimes />
              </button>
            </div>
            <div className="qr-payment-modal-body">
              <div className="qr-payment-status-large">
                <QRCodeSVG 
                  value={`INVOICE:${selectedInvoice.invoiceNo}`} 
                  size={150}
                  level="H"
                  ...
                  bgColor="#ffffff"
                />
                <div className="qr-payment-text">Paid</div>
                <div className="qr-payment-invoice">Invoice: {selectedInvoice.invoiceNo}</div>
              </div>
            </div>
          </div>
        </div>
