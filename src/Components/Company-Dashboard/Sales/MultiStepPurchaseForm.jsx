  ...
  const renderItemsTable = (tab) => (
    <Table striped bordered>
      ...
      <tbody>
        ...
        <tr>
          <td colSpan={tab === 'invoice' ? 7 : tab === 'quotation' ? 5 : 4} className="text-end">
  ...
  <Form.Control
    ...
    onChange={(e) => {
      ...
      if (file) {
        ...
        reader.onload = () => {
          handleChange('quotation', 'image', reader.result); // base64 image
        };
...
{/* Preview Image */}
               {formData.quotation.image && (
  <div className="mt-2">
    <img
      src={formData.quotation.image}
      alt="Company Logo"
  ...
  <Form.Control
    ...
    value={formData.quotation.createdBy}
    onChange={(e) => handleChange('quotation', 'createdBy', e.target.value)}
  />



<Form.Group className="mt-3">
  <Form.Label>Tax Column</Form.Label>
  <div>
    <Button
      variant={formData.quotation.showTax ? "success" : "secondary"}
      size="sm"
      onClick={() => handleChange('quotation', 'showTax', true)}
      className="me-2"
    >
      Tax ON
    </Button>
    <Button
      variant={formData.quotation.showTax ? "secondary" : "danger"}
      size="sm"
      onClick={() => handleChange('quotation', 'showTax', false)}
    >
      Tax OFF
    </Button>
  </div>
